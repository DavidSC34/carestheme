 ...
 *     ?>
 */
function materialize_pagination(\WP_Query $wp_query = null, $echo = true, $params = [])
{
    if (null === $wp_query) {
        global $wp_query;
    }
    ...
    if (is_array($pages)) {
        ...
        foreach ($pages as $page) {
            $pagination .= '<li class="waves-effect ' . (strpos($page, 'current') !== false ? 'active' : '') . '"> ' . str_replace('page-numbers', 'page-link', $page) . '</li>';
        }
